...
- **Cozum (Plan B)**: Bitmap ikona geri donuldu, icerik kisaltildi: `statusText = round(NAV/10000)` -> "97" ($967k), 1M ustunde "102" ($1.02M). Ayrica `createTextIcon()` ic bosluklari kisildi (maxTextW 0.84->0.94, ts 0.85->0.95). Sonuc: rakamlar ~2 kat buyudu, saat fontuna yakin okunurluk (ekran goruntusuyle dogrulandi).
